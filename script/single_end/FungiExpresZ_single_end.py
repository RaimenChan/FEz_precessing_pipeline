...
output_path = '~/FungiExpresZ/Aspergillus_nidulans/single_end/2/output'
sra_file_path = '~/FungiExpresZ/Aspergillus_nidulans/single_end/2/Aspergillus_nidulans_RNAseq-single_end_2.txt'
...
rule download:
    output:
        ...
        stat = os.path.join(output_path, "alignmentstat", "{sra_number}_alignmentstat")
    params:
